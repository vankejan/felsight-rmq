...
public class ParallelStudentMessageTarget implements MessageTarget {
    private final String semester;
    private final String course;
    private final String parallel;

    public ParallelStudentMessageTarget(String semester, String course, String parallel) {
    ...
    public boolean equals(Object o) {
        ...
        ParallelStudentMessageTarget that = (ParallelStudentMessageTarget) o;
